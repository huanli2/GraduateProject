...
% 双面打印（注意字号设置）
\documentclass[cs4size, a4paper, twoside,openany]{sjtuthesis} 
% 单面打印（注意字号设置）
...
\englishauthor{}
\englishadvisor{}
\englishauthor{Huan Li}
\englishadvisor{Prof. Xubo Yang}
\englishschool{Shanghai Jiao Tong University}
\englishinstitute{School of Software Engineering} 
